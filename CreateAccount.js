...
function handleCreate() {
  ...
  <div className = "text-center " style={{marginTop: "5rem", color: "yellow"}}> <h2>Welcome to Register your Account</h2></div>
       ...
       body = {show ? (
              ...
              Name <br/>
                  ...
                  <input type="input"  className= "form-control" 
                      id = "name" placeholder = "Enter Name" maxLength = {10} minLength= {6}
                      value = {name} onChange={e => setName(e.currentTarget.value)} name= "name" required/> <br/> 
              ...
              Email address <br/>         
                  <input type="input"  className= "form-control"
                      ...
                      value = {email} onChange={e => setEmail(e.currentTarget.value)} name= "email" required/> <br/>
                      <div className= "invalid-feedback">Please fill out this field</div>
              Password <br/> 
                      <div className="col-auto">
                        <span  className="form-text" style={{color: "yellow"}}>
                  ...
                  <input type="password"  className= "form-control"
                      id = "password" placeholder = "Enter password" maxLength = {12} minLength= {8}
                      value = {password} onChange={e => setPassword(e.currentTarget.value)} name= "password" required /> <br/>              
                      <div className= "invalid-feedback">Please fill out this field</div>

                      <div className="form-check mb-3">
                          <input className="form-check-input" type="checkbox" id="myCheck"  name="remember" required />
                          <label className="form-check-label" for="myCheck">I agree all terms and policy.</label>
